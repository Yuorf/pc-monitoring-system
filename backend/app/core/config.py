...
class Settings(BaseSettings):
    ...
    METRICS_FAST_STARTUP_ENABLED: bool = True
    METRICS_FAST_STARTUP_DURATION_SECONDS: int = 120
    METRICS_FAST_STARTUP_INTERVAL_SECONDS: int = 10
    SMART_COLLECTION_INTERVAL_SECONDS: int = 60
